package net.Harmonioncraft.client.models;
...
public class ModelHarmonionWolf extends ModelBase
{
    ...
    {
    	EntityHarmonionWolf var5 = (EntityHarmonionWolf)par1EntityLiving;
