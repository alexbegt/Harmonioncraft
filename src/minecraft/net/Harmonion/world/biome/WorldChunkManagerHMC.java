...
public class WorldChunkManagerHMC extends WorldChunkManager
{
    ...
    public WorldChunkManagerHMC(long par1, WorldType par3WorldType)
    {
        this();
    ...
    public WorldChunkManagerHMC(World par1World)
    {
