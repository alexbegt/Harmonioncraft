package net.Harmonion.world.gen;
...
import net.Harmonion.world.gen.feature.WorldPopMinable;
...
public class ChunkProviderHarmonion implements IChunkProvider
{
    private Random rand;
    ...
    public ChunkProviderHarmonion(World var1, long var2, boolean var4)
    {
        this.worldObj = var1;
    ...
    public void replaceBlocksForBiome(int var1, int var2, byte[] var3, BiomeGenBase[] var4)
    {
        ...
        for (int var8 = 0; var8 < 16; ++var8)
        {
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                byte var15 = (byte)Block.grass.blockID;
    ...
    public void populate(IChunkProvider var1, int var2, int var3)
    {
        ...
        for (var13 = 0; var13 < 3; ++var13)
        {
            ...
            (new WorldPopMinable(ModBlocks.HarmonionOre.blockID, 0, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
        }
        ...
        for (var13 = 0; var13 < 3; ++var13)
        {
            ...
            var15 = this.rand.nextInt(128);
            var16 = var5 + this.rand.nextInt(16);
            (new WorldPopMinable(ModBlocks.HarmonionOre.blockID, 1, 8)).generate(this.worldObj, this.rand, var14, var15, var16);
        }

        /**WorldGenHarmonionTree var17 = new WorldGenHarmonionTree();
        int var19;
        int var18;
        int var21;
        int var20;

        for (var19 = 0; var19 < 14; ++var19)
        {
