...
public class ComponentWizardTower extends ComponentVillage
{
    ...
    public static final WeightedRandomChestContent[] towerChestContents = new WeightedRandomChestContent[] {new WeightedRandomChestContent(Item.lightStoneDust.shiftedIndex, 0, 1, 3, 3), new WeightedRandomChestContent(Item.glassBottle.shiftedIndex, 0, 1, 5, 10), new WeightedRandomChestContent(Item.goldNugget.shiftedIndex, 0, 1, 3, 5), new WeightedRandomChestContent(Item.fireballCharge.shiftedIndex, 0, 1, 1, 5), new WeightedRandomChestContent(Item.skull.shiftedIndex, 0, 1, 1, 3), new WeightedRandomChestContent(ModItems.Harmonionhelmet.shiftedIndex, 1, 1, 1, 1), new WeightedRandomChestContent(ModItems.Harmonionchestplate.shiftedIndex, 0, 1, 1, 1), new WeightedRandomChestContent(ModItems.Harmonionlegs.shiftedIndex, 0, 1, 1, 1), new WeightedRandomChestContent(ModItems.Harmonionboots.shiftedIndex, 0, 1, 1, 1)};
