...
public class TeleporterHarmonion extends Teleporter
{
    ...
    public TeleporterHarmonion(WorldServer var1)
    {
        super(var1);
        this.myWorld = var1;
    }
    ...
    private void makePortalAt(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlock(var2 + 0, var3 + 0, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 0, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 0, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 0, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 0, var3 + 0, var4 + 2, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 0, var4 + 2, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 0, var3 + 0, var4 + 0, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 0, var4 + 0, ModBlocks.HarmonionBlock.blockID);
        ...
        var1.setBlock(var2 + 0, var3 + 1, var4 + 1, ModBlocks.HarmonionPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 1, var4 + 1, ModBlocks.HarmonionPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 2, var4 + 1, ModBlocks.HarmonionPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 2, var4 + 1, ModBlocks.HarmonionPortal.blockID);
        var1.setBlock(var2 + 0, var3 + 3, var4 + 1, ModBlocks.HarmonionPortal.blockID);
        var1.setBlock(var2 + 1, var3 + 3, var4 + 1, ModBlocks.HarmonionPortal.blockID);
        var1.setBlock(var2 - 1, var3 + 1, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 1, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 2, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 2, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 3, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 3, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 0, var3 + 4, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 1, var3 + 4, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 + 2, var3 + 4, var4 + 1, ModBlocks.HarmonionBlock.blockID);
        var1.setBlock(var2 - 1, var3 + 4, var4 + 1, ModBlocks.HarmonionBlock.blockID);
