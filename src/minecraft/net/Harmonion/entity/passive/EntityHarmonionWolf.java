package net.Harmonion.entity.passive;
...
public class EntityHarmonionWolf extends EntityTameable
{
    ...
    public EntityHarmonionWolf(World par1World)
    {
        super(par1World);
        this.texture = Reference.WOLF_SHEET_LOCATION + Reference.LMM_WOLF_MAIN_SHEET;
    ...
    {
        return this.isTamed() ? Reference.WOLF_SHEET_LOCATION + Reference.LMM_WOLF_TAIMED_SHEET : (this.isAngry() ? Reference.WOLF_SHEET_LOCATION + Reference.LMM_WOLF_ANGRY_SHEET : super.getTexture());
    }
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityHarmonionWolf))
        {
            return false;
        }
        else
        {
        	EntityHarmonionWolf var2 = (EntityHarmonionWolf)par1EntityAnimal;
