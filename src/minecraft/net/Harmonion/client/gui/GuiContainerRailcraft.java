...
public abstract class GuiContainerRailcraft extends GuiContainer
{
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        if (var6.getItemStack() == null)
        {
            ...
            while (var7.hasNext())
            {
                LiquidGauge var8 = (LiquidGauge)var7.next();

                if (this.isMouseOverGauge(var8, var1, var2))
                {
                    var9 = var8.getToolTip();
    ...
    private boolean isMouseOverGauge(LiquidGauge var1, int var2, int var3)
    {
        int var4 = this.guiLeft;
        int var5 = this.guiTop;
        var2 -= var4;
    ...
    public void drawLiquidGauge(LiquidGauge var1)
    {
        ...
        if (var1.tank != null)
        {
            LiquidStack var4 = var1.tank.getLiquid();

            if (var4 != null)
            {
                int var5 = LiquidRenderer.bindLiquidTexture(var4);

                if (var5 >= 0)
                {
                    int var6 = var5 / 16;
                    int var7 = var5 - var6 * 16;
                    int var8 = (int)Math.ceil((double)((float)Math.min(var4.amount, var1.tank.getCapacity()) / (float)var1.tank.getCapacity() * (float)var1.h));
                    int var9;

                    for (var9 = 0; var9 < var1.w / 16; ++var9)
                    {
                        int var10 = 0;
                        int var11 = var8;
                        int var13;
                        ...
                        do
                        {
                            ...
                            this.drawTexturedModalRect(var2 + var1.x + var9 * 16, var3 + var1.y + var1.h - var13 - var10, var7 * 16, var6 * 16 + (16 - var13), 16, 16 - (16 - var13));
                            var10 += 16;
                        }
                        while (var13 != 0 && var11 != 0);
                    }

                    var9 = this.mc.renderEngine.getTexture(this.texturePath);
                    this.mc.renderEngine.bindTexture(var9);
                    this.drawTexturedModalRect(var2 + var1.x, var3 + var1.y, this.xSize, 0, var1.w, var1.h);
                }
            }
        }
    }
