...
public abstract class TileWiring extends TileCovered implements IWiring
{
    ...
    public void addHarvestContents(ArrayList var1)
    {
        ...
        for (int var2 = 0; var2 < 6; ++var2)
        {
            ...
            {
                var1.add(new ItemStack(ModBlocks.blockMicro.blockID, 1, this.getExtendedID() * 256 + this.Metadata));
            }
        }
        ...
        if ((this.ConSides & 64) > 0)
        {
            ...
            var1.add(new ItemStack(ModBlocks.blockMicro.blockID, 1, var3));
        }
    }
    ...
    public boolean refreshBlockSupport()
    {
        ...
        for (var1 = 0; var1 < 6; ++var1)
        {
            if ((this.ConSides & 1 << var1) != 0 && (var2 || !RedPowerLib.canSupportWire(this.worldObj, this.xCoord, this.yCoord, this.zCoord, var1)))
            {
                ...
                CoreLib.dropItem(this.worldObj, this.xCoord, this.yCoord, this.zCoord, new ItemStack(ModBlocks.blockMicro.blockID, 1, this.getExtendedID() * 256 + this.Metadata));
    ...
    public void onHarvestPart(EntityPlayer var1, int var2)
    {
        ...
        if (var2 == 29 && (this.ConSides & 64) > 0)
        {
            ...
            CoreLib.dropItem(this.worldObj, this.xCoord, this.yCoord, this.zCoord, new ItemStack(ModBlocks.blockMicro.blockID, 1, var4));
            this.ConSides &= 63;
        }
        else
        {
        ...
        CoreLib.markBlockDirty(this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        RedPowerLib.updateIndirectNeighbors(this.worldObj, this.xCoord, this.yCoord, this.zCoord, ModBlocks.blockMicro.blockID);
    }

    public float getPartStrength(EntityPlayer var1, int var2)
    {
        BlockMicro var3 = ModBlocks.blockMicro;
