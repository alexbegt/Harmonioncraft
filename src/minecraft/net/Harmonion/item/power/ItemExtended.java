...
import net.Harmonion.block.power.BlockExtended;
...
public class ItemExtended extends ItemBlock
{
    ...
    {
        if (!var3.setBlockAndMetadataWithNotify(var4, var5, var6, this.shiftedIndex, var11))
        {
            return false;
        }
        else
        {
            if (var3.getBlockId(var4, var5, var6) == this.shiftedIndex)
            {
                BlockExtended var12 = (BlockExtended)Block.blocksList[this.shiftedIndex];
