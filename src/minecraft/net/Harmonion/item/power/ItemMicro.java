    ...
    private boolean useCover(ItemStack var1, EntityPlayer var2, World var3, int var4, int var5, int var6, int var7)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    var3.setBlockAndMetadata(var8.blockX, var8.blockY, var8.blockZ, ModBlocks.blockMicro.blockID, 0);
                }
                ...
                else
                {
                    ...
                    if (var10.tryAddCover(var8.subHit, CoverLib.damageToCoverValue(var1.getItemDamage())))
                    {
                        ...
                        RedPowerLib.updateIndirectNeighbors(var3, var8.blockX, var8.blockY, var8.blockZ, ModBlocks.blockMicro.blockID);
        ...
        if (var2 != ModBlocks.tabHarmonioncraftW && var2 != ModBlocks.tabHarmonioncraftB)
        {
            if (var2 == ModBlocks.tabHarmonioncraftB)
            {
                ...
                for (var4 = 0; var4 < 255; ++var4)
                {
                    ...
                    if (var5 != null)
                    {
                        var3.add(new ItemStack(ModBlocks.blockMicro, 1, var4));
                    }
                }
                ...
                for (var4 = 1; var4 < 255; ++var4)
                {
                    ...
                    if (var5 != null)
                    {
                        var3.add(new ItemStack(ModBlocks.blockMicro, 1, var4 << 8));
                    }
                }
                ...
                for (var4 = 1; var4 < 255; ++var4)
                {
                    ...
                    if (var5 != null)
                    {
                        var3.add(new ItemStack(ModBlocks.blockMicro, 1, var4 << 8 | 2));
                    }
                }
                ...
                for (var4 = 1; var4 < 255; ++var4)
                {
                    ...
                    if (var5 != null)
                    {
                        var3.add(new ItemStack(ModBlocks.blockMicro, 1, var4 << 8 | 23));
                    }
                }
                ...
                for (var4 = 1; var4 < 255; ++var4)
                {
                    ...
                    if (var5 != null)
                    {
                        var3.add(new ItemStack(ModBlocks.blockMicro, 1, var4 << 8 | 26));
                    }
                }
            }
        }
