...
public class ItemHarmonionTool extends ItemHarmonion {
	    ...
	    protected ItemHarmonionTool(int par1, int par2, EnumToolMaterial par3EnumToolMaterial, Block[] par4ArrayOfBlock)
	    {
	        super(par1);
	        ...
	        this.setCreativeTab(ModItems.tabHarmonionI);//CreativeTabs.tabTools);
	    }
