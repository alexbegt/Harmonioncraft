...
public class BlockHarmonionFire extends Block
{
    public BlockHarmonionFire(int var1, int var2)
    {
    ...
    {
        if (var1.provider.dimensionId > 0 || var1.getBlockId(var2, var3 - 1, var4) != ModBlocks.HarmonionBlock.blockID || !ModBlocks.HarmonionPortal.tryToCreatePortal(var1, var2, var3, var4))
        {
            if (!var1.doesBlockHaveSolidTopSurface(var2, var3 - 1, var4))
            {
                var1.setBlockWithNotify(var2, var3, var4, 0);
