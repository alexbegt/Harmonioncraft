...
import net.Harmonion.carts.network.PacketHMCC;
import net.Harmonion.carts.network.PacketTypeHandler;
...
public class PacketHandler implements IPacketHandler {
    ...
    public void onPacketData(INetworkManager manager, Packet250CustomPayload packet, Player player) {
    	...
    	PacketHMCC packethmc = PacketTypeHandler.buildPacket(packet.data);
