...
public class Reference {
    ...
    public static final String SERVER_PROXY_CLASS = "net.Harmonion.carts.main.CommonProxy";
    public static final String CLIENT_PROXY_CLASS = "net.Harmonion.carts.main.ClientProxy";
    ...
    public static final String SPRITE_SHEET_LOCATION = "/net/Harmonion/carts/textures/";
    ...
    public static final String GUI_SHEET_LOCATION = "/net/Harmonion/carts/textures/gui/";
    public static final String ARMOR_SHEET_LOCATION = "/net/Harmonion/carts/textures/armor/";
    
    public static final String WOLF_SHEET_LOCATION = "/net/Harmonion/carts/textures/entity/";
