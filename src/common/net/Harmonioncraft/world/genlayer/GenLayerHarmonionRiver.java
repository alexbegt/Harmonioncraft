...
public class GenLayerHarmonionRiver extends GenLayerHarmonion
{
    public GenLayerHarmonionRiver(long var1, GenLayer var3)
    {
        super(var1);
        super.parent = var3;
    }
        ...
        for (int var11 = 0; var11 < var4; ++var11)
        {
            for (int var12 = 0; var12 < var3; ++var12)
            {
                ...
                if (var17 != 0 && var13 != 0 && var14 != 0 && var15 != 0 && var16 != 0)
                {
                    ...
                    {
                        var10[var12 + var11 * var3] = BiomeGenHarmonion.HarmonionRiver.biomeID;
                    }
                }
                else
                {
