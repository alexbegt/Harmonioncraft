...
public class GenLayerHarmonionExpand extends GenLayerHarmonion
{
    public GenLayerHarmonionExpand(long var1, GenLayer var3)
    {
        super(var1);
        this.parent = var3;
    }
    ...
    public int[] getInts(int var1, int var2, int var3, int var4)
    {
        ...
        for (int var11 = 0; var11 < var4; ++var11)
        {
            for (int var12 = 0; var12 < var3; ++var12)
            {
                ...
                if (var17 == 60 && (var13 != 60 || var14 != 60 || var15 != 60 || var16 != 60))
                {
                    var10[var12 + var11 * var3] = this.nextInt(6) + 60;
                }
                else
                {
