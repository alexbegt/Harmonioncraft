...
public class NetworkManager implements IPacketHandler{
	...
	class TileEntityField
	{
	    ...
	    TileEntityField(NetworkManager var1, TileEntity var2, String var3)
	    {
	        this.this$0 = var1;
	        this.target = null;
	        this.te = var2;
	    ...
	    TileEntityField(NetworkManager var1, TileEntity var2, String var3, EntityPlayerMP var4)
	    {
	        this.this$0 = var1;
	        this.target = null;
	        this.te = var2;
	    ...
	    {
	        if (!(var1 instanceof TileEntityField))
	        {
	            return false;
	        }
	        else
	        {
	            TileEntityField var2 = (TileEntityField)var1;
	            return var2.te == this.te && var2.field.equals(this.field);
	        }
	    }
