...
public class ConfigurationHandler {
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            /* General Configs */
            ConfigurationSettings.ENABLE_VERSION_NOTICE = configuration
            		.get(CATEGORY_GENERAL, Reference.ENABLE_VERSION_NOTICE, ConfigurationSettings.ENABLE_VERSION_NOTICE_DEFAULT)
            		.getBoolean(ConfigurationSettings.ENABLE_VERSION_NOTICE_DEFAULT);
