...
public class HMCTeleporter extends Teleporter {
    ...
    {
        if (par1World.provider.worldType != 9)
        {
            ...
            for (int var8 = -2; var8 <= 2; ++var8)
            {
                for (int var9 = -2; var9 <= 2; ++var9)
                {
                    for (int var10 = -1; var10 < 3; ++var10)
                    {
                        ...
                        par1World.setBlockWithNotify(var11, var12, var13, var14 ? ModBlocks.HarmonionBlock.blockID : 0);
                    }
                }
            }
            ...
            for (var20 = -1; var20 <= 1; ++var20)
            {
                for (var21 = 1; var21 < 3; ++var21)
                {
                    for (var22 = -1; var22 < 3; ++var22)
                    {
                        ...
                        var33 = var22 < 0;
                        par1World.setBlockWithNotify(var23, var24, var25, var33 ? ModBlocks.HarmonionBlock.blockID : 0);
                    }
                }
            }
        }
        ...
        for (var20 = 0; var20 < 4; ++var20)
        {
            ...
            for (var21 = 0; var21 < 4; ++var21)
            {
                for (var22 = -1; var22 < 4; ++var22)
                {
                    ...
                    par1World.setBlockWithNotify(var23, var24, var25, var33 ? ModBlocks.HarmonionBlock.blockID : ModBlocks.HarmonionPortal.blockID);
                }
            }
