...
public class HMCGenCaves extends MapGenBase4096 {
	
	protected void generateLargeCaveNode(long var1, int var3, int var4, short[] var5, double var6, double var8, double var10)
    {
        this.generateCaveNode(var1, var3, var4, var5, var6, var8, var10, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    protected void generateCaveNode(long var1, int var3, int var4, short[] var5, double var6, double var8, double var10, float var12, float var13, float var14, int var15, int var16, double var17)
    {
                            ...
                            for (var51 = var47; var51 < var48; ++var51)
                            {
                                ...
                                if (var63 * var63 + var54 * var54 < 1.0D)
                                {
                                    for (int var58 = var46 - 1; var58 >= var45; --var58)
                                    {
                                        ...
                                        if (var59 > -0.7D && var63 * var63 + var59 * var59 + var54 * var54 < 20.0D)
                                        {
                                            short var61 = var5[var56];
                                            ...
                                            {
                                                if (var63 * var63 + var59 * var59 + var54 * var54 < 0.85D)
                                                {
                                                    var5[var56] = var58 < 10 ? (short)Block.waterMoving.blockID : 0;
                                                }
                                                else
                                                {
                                                    var5[var56] = var57 ? (short)Block.grass.blockID : (short)Block.dirt.blockID;
                                                    var57 = false;
                                                }

                                                if (var57 && var5[var56 - 1] == Block.dirt.blockID)
                                                {
                                                    var5[var56 - 1] = (short)this.worldObj.getBiomeGenForCoords(var50 + var3 * 16, var51 + var4 * 16).topBlock;
                                                }
                                            }
                                        }
