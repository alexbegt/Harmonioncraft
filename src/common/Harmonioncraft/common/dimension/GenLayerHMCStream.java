...
public class GenLayerHMCStream extends GenLayer {
    ...
    {
        return var1 == var2 ? false : (var1 == -var2 ? false : (var1 == HMCBiomeBase.glacier.biomeID && var2 == HMCBiomeBase.snow.biomeID ? false : (var1 == HMCBiomeBase.snow.biomeID && var2 == HMCBiomeBase.glacier.biomeID ? false : (var1 == HMCBiomeBase.deepMushrooms.biomeID && var2 == HMCBiomeBase.mushrooms.biomeID ? false : (var1 == HMCBiomeBase.mushrooms.biomeID && var2 == HMCBiomeBase.deepMushrooms.biomeID ? false : (var1 == HMCBiomeBase.swamp.biomeID && var2 == HMCBiomeBase.fireSwamp.biomeID ? false : (var1 == HMCBiomeBase.fireSwamp.biomeID && var2 == HMCBiomeBase.swamp.biomeID ? false : (var1 != HMCBiomeBase.tfLake.biomeID && var2 != HMCBiomeBase.tfLake.biomeID ? (var1 != HMCBiomeBase.clearing.biomeID && var2 != HMCBiomeBase.clearing.biomeID ? !HMCBiomeBase.isFeature(var1) && !HMCBiomeBase.isFeature(var2) : false) : false))))))));
    }
}
