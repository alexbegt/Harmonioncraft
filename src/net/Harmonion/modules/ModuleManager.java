...
public abstract class ModuleManager
{
    ...
    {
        registerModule(Module.TANKS, new ModuleTanks());
        Locale var0 = Locale.getDefault();
        Locale.setDefault(Locale.ENGLISH);
        Configuration var1 = new Configuration(new File(Loader.instance().getConfigDir() + "/Harmonion/", "modules.cfg"));
        var1.load();
        var1.addCustomCategoryComment("modules", "Disabling these modules can greatly change how the mod functions.");
        var1.categories.remove("block");
        var1.categories.remove("item");
        var1.categories.remove("general");
        ...
        for (int var4 = 0; var4 < var3; ++var4)
        {
            ...
            if (var5 != Module.TANKS && !isEnabled(var1, var5))
            {
