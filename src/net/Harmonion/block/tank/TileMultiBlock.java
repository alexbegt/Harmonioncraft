...
import net.Harmonion.util.network.PacketTileRequest;
...
public abstract class TileMultiBlock extends TileMachineBase
{
    ...
    private void grabNeighbors() {
        ...
        for (int side = 0; side < 6; side++) {
          ...
          if (!MiscTools.blockExistsOnSide(this.worldObj, this.xCoord, this.yCoord, this.zCoord, dir)) {
            this.checkNeighbors = true;
          }
          else {
        	  TileEntity tile = MiscTools.getBlockTileEntityOnSide(this.worldObj, this.xCoord, this.yCoord, this.zCoord, dir);
