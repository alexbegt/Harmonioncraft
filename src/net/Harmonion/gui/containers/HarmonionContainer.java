...
import net.Harmonion.gui.slots.IPhantomSlot;
import net.Harmonion.gui.slots.SlotBase;
...
public abstract class HarmonionContainer extends Container
{
    ...
    public void addGauge(LiquidGauge var1)
    {
        this.gauges.add(var1);
    }
    ...
    protected boolean shiftItemStack(ItemStack var1, int var2, int var3)
    {
        ...
        if (var1.isStackable())
        {
            for (var5 = var2; var1.stackSize > 0 && var5 < var3; ++var5)
            {
                ...
                if (var7 != null && InvTools.isItemEqual(var7, var1))
                {
