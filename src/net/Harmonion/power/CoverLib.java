...
public class CoverLib
{
    ...
    public static void addMaterialHandler(IMaterialHandler var0)
    {
    ...
    public static void addMaterial(int var0, int var1, boolean var2, Block var3, int var4, String var5, String var6)
    {
        ...
        while (var9.hasNext())
        {
            IMaterialHandler var10 = (IMaterialHandler)var9.next();
    ...
    public static boolean checkPlacement(int var0, short[] var1, int var2, boolean var3)
    {
        boolean var7 = false;
        boolean var8 = false;
        PlacementValidator var9 = new PlacementValidator(var0, var1);
        ...
        if (blockCoverPlate != null)
        {
            if (var4 != 0)
            {
                ...
                if (var6 != null)
                {
                    ...
                    var6.Covers = var5;
                    HarmonionLib.updateIndirectNeighbors(var0, var1, var2, var3, blockCoverPlate.blockID);
                }
            }
        }
    }
