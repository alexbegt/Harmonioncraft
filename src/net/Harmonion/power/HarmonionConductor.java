...
public abstract class HarmonionConductor
{
    ...
    public void recache(int var1, int var2)
    {
        ...
        {
            if ((var1 & HarmonionLib.getConDirMask(var4 * 2)) > 0)
            {
                var3 |= 1 << var4;
            }
        }
    ...
    public void iterate()
    {
        ...
        while (var3 > 0)
        {
            ...
            IHarmonionConnectable var16 = (IHarmonionConnectable)CoreLib.getTileEntity(var2, var7, IHarmonionConnectable.class);
            ...
            {
                HarmonionConductor var9 = var16.getBlueConductor(var6 ^ 1);
