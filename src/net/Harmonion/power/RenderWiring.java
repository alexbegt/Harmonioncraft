...
public abstract class RenderWiring extends RenderCovers
{
    ...
    public void renderWireBlock(int var1, int var2, int var3, int var4)
    {
        ...
        if ((var1 & 1) > 0)
        {
            ...
            this.renderSideWires(HarmonionLib.mapConToLocal(var2, 0), HarmonionLib.mapConToLocal(var5, 0), 0);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var4, 0), 0);
        }

        if ((var1 & 2) > 0)
        {
            this.context.setOrientation(1, 0);
            this.renderSideWires(HarmonionLib.mapConToLocal(var2, 1), HarmonionLib.mapConToLocal(var5, 1), 1);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var4, 1), 1);
        }

        if ((var1 & 4) > 0)
        {
            this.context.setOrientation(2, 0);
            this.renderSideWires(HarmonionLib.mapConToLocal(var2, 2), HarmonionLib.mapConToLocal(var5, 2), 2);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var3, 2) & 14, 2);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var4, 2), 2);
        }

        if ((var1 & 8) > 0)
        {
            this.context.setOrientation(3, 0);
            this.renderSideWires(HarmonionLib.mapConToLocal(var2, 3), HarmonionLib.mapConToLocal(var5, 3), 3);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var3, 3) & 14, 3);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var4, 3), 3);
        }

        if ((var1 & 16) > 0)
        {
            this.context.setOrientation(4, 0);
            this.renderSideWires(HarmonionLib.mapConToLocal(var2, 4), HarmonionLib.mapConToLocal(var5, 4), 4);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var3, 4) & 14, 4);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var4, 4), 4);
        }

        if ((var1 & 32) > 0)
        {
            this.context.setOrientation(5, 0);
            this.renderSideWires(HarmonionLib.mapConToLocal(var2, 5), HarmonionLib.mapConToLocal(var5, 5), 5);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var3, 5) & 14, 5);
            this.renderEndCaps(HarmonionLib.mapConToLocal(var4, 5), 5);
        }
    }
