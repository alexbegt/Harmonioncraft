...
import net.Harmonion.api.core.INetworkedObject;
import net.Harmonion.util.misc.MiscTools;
import net.Harmonion.util.network.PacketBuilder;
import net.Harmonion.util.network.PacketTileEntity;
...
public abstract class HarmonionTileEntity extends TileEntity implements INetworkedObject
{
    ...
    {
        int var3 = MiscTools.getBlockIdOnSide(this.worldObj, this.xCoord, this.yCoord + var1, this.zCoord, var2);

        if (var3 == Block.redstoneWire.blockID)
        {
            int var4 = MiscTools.getBlockMetadataOnSide(this.worldObj, this.xCoord, this.yCoord + var1, this.zCoord, var2);
