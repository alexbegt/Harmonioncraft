...
public class ItemHarmonionDoor extends ItemHarmonion {
	
    private Material doorMaterial;

    public ItemHarmonionDoor(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
        this.setCreativeTab(ModItems.tabHarmonionI);//CreativeTabs.tabRedstone);
