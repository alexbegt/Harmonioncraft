...
public class GenLayerHMCBiomes extends GenLayer
{
    ...
    {
        super(var1);
        this.commonBiomes = new BiomeGenBase[] {HMCBiomeBase.HMC, HMCBiomeBase.HMC2, HMCBiomeBase.highlands, HMCBiomeBase.mushrooms, HMCBiomeBase.swamp, HMCBiomeBase.clearing, HMCBiomeBase.darkForest};
        this.rareBiomes = new BiomeGenBase[] {HMCBiomeBase.HMCLake, HMCBiomeBase.glacier, HMCBiomeBase.deepMushrooms, HMCBiomeBase.enchantedForest, HMCBiomeBase.fireSwamp};
        this.parent = var3;
    }
